...
> 生成于 2026-08-31 ｜ 依据：当前代码实测（01 篇）+ docs/research/ 九项目调研（设计输入）。
...
8. **[08 路线图](08-roadmap.md)** — M0–M5 工作包分解、退出标准、横切策略、风险登记（**取代 research/11 的粗排**）
