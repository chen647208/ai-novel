...
import { Project, KnowledgeItem, KnowledgeCategory, SearchResult, HybridSearchResult, Location, Faction, DiagramType, ModelConfig, EmbeddingModelConfig } from '../../../shared/types';
...
const StepKnowledgeEnhanced: React.FC<StepKnowledgeEnhancedProps> = ({ project, onUpdate, activeModel: propActiveModel }) => {
  ...
  const [consistencyPrompts, setConsistencyPrompts] = useState<import('../../../shared/types').ConsistencyCheckPromptTemplate[]>([]);
  const [consistencyConfig, setConsistencyConfig] = useState<import('../../../shared/types').ConsistencyCheckConfig | null>(null);
